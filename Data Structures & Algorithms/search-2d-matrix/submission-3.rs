impl Solution {
    pub fn search_matrix(matrix: Vec<Vec<i32>>, target: i32) -> bool {
        ...
        while l <= r {
            ...
            if matrix[mid as usize][last_col_index] == target || matrix[mid as usize][0] == target {
                return true;
            } else if matrix[mid as usize][last_col_index] > target && matrix[mid as usize][0] < target {
